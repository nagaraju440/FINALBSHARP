    ...
    return (
      <View style={{ marginTop: 50, width, height:256 }}>
        ...
        showsHorizontalScrollIndicator={false}> 
          <View style={{height:256,width:169,marginLeft:20,borderWidth:3,borderColor:'#EEEEEE',borderRadius:5}}>
           <Image
          ...
          <View style={{height:254,width:167,marginLeft:20,borderWidth:3,borderColor:'#EEEEEE',borderRadius:5}}>
          <Image
            source={{uri:'https://images.pexels.com/photos/4916161/pexels-photo-4916161.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',}}
            style={{width:76,height:76,borderRadius:76,marginTop:20,marginLeft:45}}>
           </Image>
