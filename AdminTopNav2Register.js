...
class AdminTopNav2Register extends React.Component {
  constructor(props){
    super(props);
    this.state={
        Status:"", txnId:"",
        name:this.props.route.params.userData.name,
        age:this.props.route.params.userData.age,
        number:this.props.route.params.userData.number,
        email:this.props.route.params.userData.email,
        courseData:'',
        batchNo:this.props.route.params.userData.BatchNo
    }
}
  componentDidMount=()=>{
       ...
       {/* .........................top bsharp..............................      */}
            ...
            {/* <StckNav */}
                ...
                <View style={styles.TopNav}>
                    ...
                    <Image source={{uri:this.props.route.params.img}} style={styles.Image} />
...
export default AdminTopNav2Register;