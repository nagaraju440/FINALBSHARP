...
import UpArrow from '../DrawerNavFiles/svgIcons/UpArrow';
import DownArrow from '../DrawerNavFiles/svgIcons/DownArrow';
 ...
 class SelectSlot extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      value: this.props.route.params.userData.BatchNo,
      setValue: '',
      videoUrl:''
    };
  }
  componentDidMount = () => {
    console.log(this.props.route.params.userData, 'isvideo url hehehehhehehhe');
    // this.setState({videoUrl:this.props.route.params.batchesData.videoUrl})
  };
  register = () => {
    ...
    if(this.state.value===''){
      ...
      if( Object.keys(snapshot.val()).length===12){
        ...
        this.props.navigation.navigate({name:'AdminRegister',params:{data:this.props.route.params.batchesData,batchNo:this.state.value,img:this.props.route.params.img,userData:this.props.route.params.userData}})
      }
      });
    }
            ...
            <View style={{flex: 1, alignItems: 'center'}}>
              <View
                ...
                }}>
               {
                  ...
                  <Image source={{uri:this.props.route.params.img}} style={{width:'100%',height:'100%'}}></Image>
                //   <Video
                        ...
                        {this.state.y === false ? (
                          ...
                          <View style={{width: width, height: 180}}>
                            ...
                            <View style={{marginLeft: 15}}>
                              {Object.values(
                                this.props.route.params.batchesData.Batches,
                              ).map((l, i) => {
                                console.log(l.day)
                                if (l.day === 'saturday') {
                                  return (
