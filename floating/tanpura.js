...
class Tanpura extends React.Component {
    ...
    play=()=>{
        ...
        this.state.whoosh = new Sound(this.state.sound, Sound.MAIN_BUNDLE,(error) => {
            ...
            // loaded successfully
            console.log('duration in seconds: ' + this.state.whoosh.getDuration() + 'number of channels: ' + this.state.whoosh.getNumberOfChannels());
            ...
            <View style={{ borderColor: "#707070", borderWidth: 1, borderRadius: 10, marginTop: 15 }}>
                <Picker
                    ...
                    onValueChange={(itemValue, itemIndex) => {
                        ...
                        this.setState({second:this.state.second,sound:this.state.sound})
...
// whoosh.pause();
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 30 }}>
               ...
               <View style={{ borderWidth: 1, height: 40, width: '40%', borderRadius: 10, borderColor: '#707070', backgroundColor: '#292629', justifyContent: 'center' }}>
                    <TouchableOpacity
                    onPress={this.play}
                ...
                <View style={{ borderWidth: 1, height: 40, width: '40%', borderRadius: 10, borderColor: '#707070', backgroundColor: '#292629', justifyContent: 'center',marginLeft:40 }}>
                    <TouchableOpacity
                    onPress={()=>{
                        ...
                        style={{ alignItems: 'center' }}
                    >
                        <Text style={{ color: '#FFFFFF', alignItems: 'center' }}>Stop</Text>
                    </TouchableOpacity>
                </View>
               </View>
