      ...
      <View style={{backgroundColor: 'white'}}>
        ...
        <View style={styles.container}>
          <View>
            ...
            <Text
              style={{borderBottomWidth: 3, width: 60, marginTop: -5}}></Text>
            <Text>{'\n'}</Text>
          </View>
          ...
          <LinearGradient
            ...
            <View style={styles.leftText}>
              ...
              <View style={{alignItems: 'center'}}>
                <Text style={styles.textColor}>Saturday & sunday</Text>
                <Text style={styles.textColor}>
                  7:00pm to 8:30pm{'\n'} {'\n'}
                </Text>
              </View>

              <Text style={styles.textColor}>Manosmi</Text>
            </View>
