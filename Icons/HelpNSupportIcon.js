...
function HelpNSupportIcon(){
    return(
        <Svg style={styles.Sections} id="chat_1_" data-name="chat (1)" xmlns="http://www.w3.org/2000/svg" width="17.582" height="21.061" viewBox="0 0 17.582 21.061">
...
export default HelpNSupportIcon